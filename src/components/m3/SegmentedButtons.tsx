...
export function SegmentedButtons({
  ...
  return (
    <div
      role="tablist"
      className={cn(
        "inline-flex rounded-lg border border-m3-outline-variant bg-m3-surface-container-low p-1",
        h,
        className,
      )}
    >
      {segments.map((s) => {
        ...
        return (
          <button
            ...
            className={cn(
              "state-layer press relative inline-flex items-center gap-1.5 rounded-md px-3.5 text-[13px] font-medium",
