  ...
  return (
    <div ref={ref} className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="group inline-flex items-center gap-2 rounded-lg border border-[hsl(var(--line))] bg-[hsl(var(--card))]/80 backdrop-blur px-1.5 py-1 pr-3 hover:border-[hsl(var(--line-2))] transition-colors"
        aria-haspopup="menu"
        aria-expanded={open}
      >
        {user.photoURL ? (
