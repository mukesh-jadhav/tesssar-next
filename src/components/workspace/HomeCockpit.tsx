      ...
      <section className="min-h-0 overflow-auto scrollbar-thin">
        <div className="h-full flex flex-col p-8 md:p-12 lg:p-14 xl:p-16">
            ...
            <div className="flex items-center justify-between gap-3 pt-3 border-t border-[hsl(var(--line))]">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="hidden md:inline-flex items-center gap-1.5 rounded-md border border-[hsl(var(--line-2))] px-3 py-1.5 text-[12px] text-[hsl(var(--ink-2))] hover:text-[hsl(var(--ink))] hover:bg-[hsl(var(--paper-2))] transition-colors"
          ...
          <button
            type="button"
            onClick={() => setGuidedOpen(true)}
            className="mt-4 md:hidden inline-flex items-center gap-1.5 self-start rounded-md border border-[hsl(var(--line-2))] px-3 py-1.5 text-[12px] text-[hsl(var(--ink-2))]"
          >
            <span className="ms text-[16px]" aria-hidden>auto_awesome</span>
