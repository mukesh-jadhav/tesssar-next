  ...
  return (
    <div className={compact ? "mt-1" : "mt-2"}>
      ...
      >
        ...
        Refine
        {count > 0 && (
          <span className="rounded-md bg-[hsl(var(--accent))]/15 px-1.5 py-0.5 font-mono text-[10px] tabular-nums text-[hsl(var(--accent))]">
            {count}
          </span>
        )}
        <span
      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            className={cn(
              "rounded-md border px-3 py-1 text-[12px] transition-colors press",
              active
